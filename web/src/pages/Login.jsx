    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-10rem)] px-4 py-12">
      <div className="w-full max-w-md bg-[#fcfbf7] border border-stone-300/80 rounded-2xl p-8 shadow-xs">
        <div className="mb-8 text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold text-stone-900 tracking-tight">Sign in to your account</h1>
          <p className="text-base text-stone-600 font-medium">Enter your details to access the intrusion dashboard</p>
        </div>
