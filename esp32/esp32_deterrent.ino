/*
  ...
  Features:
  - ESP32 Arduino Core v2.x & v3.x Compatible (Wokwi & Arduino IDE Ready)
  ...
  - Acoustic Frequencies & Sirens: GPIO 18 (Passive Buzzer for acoustic sweeps & ultrasonic tones)
...
// ==========================================
const char* ssid = "Wokwi-GUEST"; // Default for Wokwi; change to your Wi-Fi SSID for real hardware
const char* password = "";        // Change to your Wi-Fi password for real hardware

// GPIO Pin Definitions
#define STROBE_PIN 4      // Strobe LED / Relay trigger
#define BUZZER_PIN 18     // Passive Buzzer output pin
...
void stopDeterrent() {
  ...
  digitalWrite(STROBE_PIN, LOW);
  noTone(BUZZER_PIN);             // Silence tone sound (Core 3.x compatible)
  digitalWrite(BUZZER_PIN, LOW);
...
void updateDeterrentState() {
  ...
  // Species-Specific Frequency Acoustic Patterns for Passive Buzzer (Core 3.x compatible)
